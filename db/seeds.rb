...
e22 = Event.create(title: "FRENCH SOUL & JAZZ", description: "Born in Paris but raised in Ars-en-Re, a small village on an island off the French Atlantic Coast, and now making her home in Brooklyn, NY, Singer-songwriter Violette began her musical journey at an early age, taking up the piano at five and later learning percussion while at a Parisian Conservatory. Her musical endeavors were clearly colored by influences from such French luminaries as Jacques Brel and Edith Piaf but quickly found her tastes and palette ranging much farther than her home. Soon her speakers were filled with the sounds of Ella Fitzgerald, Stevie Wonder, and Michael Jackson, all artists whose sound would have a hand in the development of her sophisticated pop sound.", user_id: jenny.id, price: "$30", date: Date.new(2018, 2, 1), location: "New York", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490331310/https-_2F_2Fcdn.evbuc.com_2Fimages_2F28956430_2F194501316904_2F1_2Foriginal_tw0oje.png")
...
One Deep Breath Yoga offers customized corporate and private/small group yoga and meditation classes in the comfort of your own home or workplace.", user_id:jenny.id, price: "$20", date: Date.new(2018, 1, 27), location: "Seattle", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490326715/https-_2F_2Fcdn.evbuc.com_2Fimages_2F26629116_2F10102406267_2F1_2Foriginal_xfnxln.jpg")

e5 = Event.create(title: "Peanut Butter Jelly Time!", description: "Yes! That is right! It is peanut butter Jelly Time!! Join us as we go over 15 different ways to making the BEST PEANUT BUTTER JELLY SANDWICH! You will be surprised about how much you didn't know about peanut butter jelly sandwiches. From the classic to the crustless, your mouth will be watering every step of the way. We grew up eating them, we still eat them, and now it's time to try it in 15 different ways!", user_id: nancy.id, price: "$10", date: Date.new(2017, 11, 1), location: "Los Angeles", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490029040/peanutbutterjelly_v3sxbu.jpg")
...
Recreational Cooking AND Baking Classes.", user_id: john.id, price: "$20", date: Date.new(2018, 1, 27), location: "Los Angeles", image_url: "http://res.cloudinary.com/deh9l9lyq/image/upload/v1490330477/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29620931_2F20799000940_2F1_2Foriginal_ungafs.jpg")
...
you will receive an email notification before noon on the day of the event", user_id: bob.id, price: "$30", date: Date.new(2018, 2, 1), location: "San Diego", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490328415/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29580024_2F132871768924_2F1_2Foriginal_hey7lz.png")
...
This Top Talent Agent is always scouting for new talent!", user_id: jenny.id, price: "$150", date: Date.new(2018, 2, 2), location: "New York", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490329061/Spring-Break_dgxsh6.jpg")


e17 = Event.create(title: "Ian Eastwood Hip Hop Dance Workshop!", description: "Ian Eastwood is nothing short of phenomenal. He's been a YouTube sensation since the beginning of YouTube (pretty much) and his dancing/teaching/choreography/film making skills get better and better with each passing day. We are so lucky to have him back at City Dance! Save money and get your tickets in advance! Or, if you just want to watch you can buy a spectator ticket. Don't miss this :O", user_id: brandon.id, price: "$40", date: Date.new(2018, 1, 27), location: "New York", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490328066/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29283041_2F93720127529_2F1_2Foriginal_iksyoq.png")
...
Instructor Kris Finch is an accomplished portrait and illustration artist.", user_id: john.id, price: "$30", date: Date.new(2018, 2, 1), location: "San Diego", image_url: "http://res.cloudinary.com/deh9l9lyq/image/upload/v1490328714/https-_2F_2Fcdn.evbuc.com_2Fimages_2F27735076_2F131305395529_2F1_2Foriginal_qour4g.jpg")
...
We will take a quick vote and the winner will get a shout out on our social media channels and our box of 8 signature truffles, specially handcrafted by our chef.", user_id: bob.id, price: "$70", date: Date.new(2018, 2, 2), location: "New York", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490329571/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29316005_2F194395165006_2F1_2Foriginal_n7mjw8.jpg")
...
Ancho Chile Devil’s Food Cupcakes with Chocolate Ganache Frosting", user_id: brandon.id , price: "$40", date: Date.new(2018, 1, 27), location: "New York", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490331086/https-_2F_2Fcdn.evbuc.com_2Fimages_2F16641886_2F20799000940_2F1_2Foriginal_n8qywa.jpg")
...
At Turn - Boxed Lunch
2:30 PM - Distribution of Prizes", user_id: scott.id , price: "$150", date: Date.new(2018, 2, 27), location: "San Diego", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490332533/https-_2F_2Fcdn.evbuc.com_2Fimages_2F27288966_2F53052433536_2F1_2Foriginal_goyava.jpg")
#
...
KNW is a huge supporter of women in tech. We're proud to say that all of our events have featured outstanding women in the Silicon Beach community. If you're interested in helping us empower more women entrepreneurs and women in business please stop by our event and let us know how you want to get involved.", user_id: brandon.id , price: "$20", date: Date.new(2018, 2, 27), location: "Los Angeles", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490332987/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29529367_2F143123235359_2F1_2Foriginal_ncthf3.png")
...
Didn't attend an HBCU? Not about that Greek life? No Problem! This event is for ALL PARTY GOERS, Millennials, and Tastemakers!", user_id: jenny.id, price: "$10", date: Date.new(2018, 2, 27), location: "Los Angeles", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490333718/https-_2F_2Fcdn.evbuc.com_2Fimages_2F28872430_2F92870650525_2F1_2Foriginal_quuejk.jpg")
...
Hope to see you there!", user_id: john.id, price: "$100", date: Date.new(2018, 2, 27), location: "San Francisco", image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/v1490333839/https-_2F_2Fcdn.evbuc.com_2Fimages_2F28700932_2F157247754704_2F1_2Foriginal_qsdiys.jpg")
