...
One Deep Breath Yoga offers customized corporate and private/small group yoga and meditation classes in the comfort of your own home or workplace.", user_id:jenny.id, price: "$20", date: Date.new(2018, 1, 27), location: "Seattle", lat: 47.599138, lng: -122.326131, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490326715/https-_2F_2Fcdn.evbuc.com_2Fimages_2F26629116_2F10102406267_2F1_2Foriginal_xfnxln.jpg")

e5 = Event.create(title: "Peanut Butter Jelly Time!", description: "Yes! That is right! It is peanut butter Jelly Time!! Join us as we go over 15 different ways to making the BEST PEANUT BUTTER JELLY SANDWICH! You will be surprised about how much you didn't know about peanut butter jelly sandwiches. From the classic to the crustless, your mouth will be watering every step of the way. We grew up eating them, we still eat them, and now it's time to try it in 15 different ways!", user_id: nancy.id, price: "$10", date: Date.new(2017, 11, 1), location: "Los Angeles", lat: 34.045830, lng: -118.242670, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490029040/peanutbutterjelly_v3sxbu.jpg")

e6 = Event.create(title: "Internet101", description: "Ever been curious about how the internet works?? How we can connect to everyone all over the world? Join us for a one day special where we will go in dept to help demystify the internet for you. It wil be an all day event where you can meet new people who are also interested about the internet in the tech world! Food will be provided! The only thing you will need is a notebook and pen because you will be writing a lot of notes!", user_id: brandon.id, price: "$20", date: Date.new(2018, 1, 8), location: "Los Angeles", lat: 34.064532, lng: -118.229624, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490247614/internet_xxrlzm.jpg")

e7 = Event.create(title: "Warriors vs Cavs", description: "$500 front row seats! For a limited amount, we are selling front row seats for only $500 to the Cavs and Warriors game! This is a deal you will not want to miss! Not only are the tickets cheap but also, you will get to watch the top two teams in the nba go at it! This is pretty much the pewview of the finals! Don't miss out on this event! Get your tickets today!", user_id: john.id, price: "$500", date: Date.new(2018, 2, 19), location: "San Francisco", lat: 37.786174, lng: -122.455112, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490076235/ifdxscwtnl4c7jhrvwab.jpg")

e8 = Event.create(title: "Arts from the World", description: "Arts from the World brings us arts from, you guessed it, all over the world!! Join us and learn how arts from different cultures differ from each other and learn what makes them unique and idiosyncratic! We will be displaying these arts for a limited time only so buy your tickets today! Don't miss out on this amazing deal! We also encourage people to bring in their own arts to share!", user_id: brandon.id, price: "$30", date: Date.new(2018, 1, 12), location: "San Francisco", lat: 37.788860, lng: -122.401517, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490248829/welcome-world-header_nuuagr.jpg")
...
Recreational Cooking AND Baking Classes.", user_id: john.id, price: "$20", date: Date.new(2018, 1, 27), location: "Los Angeles", lat: 34.058275, lng: -118.260694, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490330477/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29620931_2F20799000940_2F1_2Foriginal_ungafs.jpg")

e9 = Event.create(title: "Career Fair for Bankers", description: "Looking for a career in banking? BOA is hosting a career fair for everyone who is interested in banking! We will have 15 to 20 recuriters come in and share about their company and who they are looking for to join their team. Make sure to bring your resume and dress to impress! See you there.", user_id: jenny.id, price: "Free", date: Date.new(2018, 1, 16), location: "New York", lat: 40.754223, lng: -73.995557, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490249377/networking_0219_wide_tixecx.jpg")

e10 = Event.create(title: "Live Concert for free", description: "Once in a life time event! We have gathered native up-and-coming artists who are willing to play for free! From live piano to live guitars and vocals, it's going to be a musical night that you don't want to miss. Great way to sit back and unwind! Grab a drink, lift up your feet, lean back and just enjoy the talent that is playing on stage! Share the news!", user_id: john.id, price: "Free", date: Date.new(2017, 11, 10), location: "San Diego", lat: 32.727827, lng: -117.162504, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490028857/liveconcert_swmg1b.jpg")

e11 = Event.create(title: "Party International", description: "Are you bored on a Friday night and want to go out and meet new people? Join us at our Party International Event! We welcome everyone from different backgrounds and ethnicities! We will serve drinks from different countries all over the world! From American Beer to margaritas to sake! Don't be shy and try new drinks from different parts of the world!", user_id: scott.id, price: "$20", date: Date.new(2018, 1, 26), location: "Los Angeles", lat: 34.036798, lng: -118.243528, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490248619/madrid-party-nightlife-clubs_hxmzyy.jpg")


## arts
e12 = Event.create(title: "Art for kids!", description: "Art for kids is a one day event for all kids ages 4 and up! We will be drawing spirit animals for the first half and then anything you want for the second half! We will have teachers around assissting kids on their drawings! Sign up your kids today to save seats!", user_id: jenny.id, price: "$20", date: Date.new(2018, 1, 27), location: "Seattle", lat: 47.617656, lng: -122.340551, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490303127/summerarts2015-IMG_9147-cropped-700x350_rtftms.jpg")

e13 = Event.create(title: "Creating Your Own Ceramic Art", description: "Join us for a peaceful session of creating your own Ceramic art! A greate way to unwind and reset for the new week! Session will be 4 hours long where we will go over different shapes to form your arts to! All ages are welcome! We have a section for kids too!", user_id: brandon.id, price: "$30", date: Date.new(2018, 1, 27), location: "New York", lat: 40.724047, lng: -74.040533, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490308446/Chuma-Maweni-567_v37kpm.jpg")

e2 = Event.create(title: "Hiking 5 Miles", description: "Happy New Year! You know what that means! That is right! It is time for our annual event! Hiking 5 Miles! We are going to go on an adventure through the rolling mountain. It is going to be an epic and wild day, so join us! If you are not fit and are worried about being too slow, don't fret! We have multiple groups going at different pace to accommodate everyone!", user_id: scott.id, price: "free", date: Date.new(2018, 1, 5), location: "San Francisco", lat: 37.796728, lng: -122.402890, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490027735/hiking_znycaj.jpg")
...
you will receive an email notification before noon on the day of the event", user_id: bob.id, price: "$30", date: Date.new(2018, 2, 1), location: "San Diego", lat: 32.700674, lng: -117.149458, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490328415/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29580024_2F132871768924_2F1_2Foriginal_hey7lz.jpg")
...
This Top Talent Agent is always scouting for new talent!", user_id: jenny.id, price: "$150", date: Date.new(2018, 2, 2), location: "New York", lat: 40.689954, lng: -73.969465, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490329061/Spring-Break_dgxsh6.jpg")


e17 = Event.create(title: "Ian Eastwood Hip Hop Dance Workshop!", description: "Ian Eastwood is nothing short of phenomenal. He's been a YouTube sensation since the beginning of YouTube (pretty much) and his dancing/teaching/choreography/film making skills get better and better with each passing day. We are so lucky to have him back at City Dance! Save money and get your tickets in advance! Or, if you just want to watch you can buy a spectator ticket. Don't miss this :O", user_id: brandon.id, price: "$40", date: Date.new(2018, 1, 27), location: "New York", lat: 40.709475, lng: -74.006887, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490328066/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29283041_2F93720127529_2F1_2Foriginal_iksyoq.jpg")
...
Instructor Kris Finch is an accomplished portrait and illustration artist.", user_id: john.id, price: "$30", date: Date.new(2018, 2, 1), location: "San Diego", lat: 32.699807, lng: -117.177267, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490328714/https-_2F_2Fcdn.evbuc.com_2Fimages_2F27735076_2F131305395529_2F1_2Foriginal_qour4g.jpg")
...
We will take a quick vote and the winner will get a shout out on our social media channels and our box of 8 signature truffles, specially handcrafted by our chef.", user_id: bob.id, price: "$70", date: Date.new(2018, 2, 2), location: "New York", lat: 40.711557, lng: -74.062505, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490329571/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29316005_2F194395165006_2F1_2Foriginal_n7mjw8.jpg")
...
Ancho Chile Devil’s Food Cupcakes with Chocolate Ganache Frosting", user_id: brandon.id , price: "$40", date: Date.new(2018, 1, 27), location: "New York", lat: 40.746420, lng: -73.973585, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490331086/https-_2F_2Fcdn.evbuc.com_2Fimages_2F16641886_2F20799000940_2F1_2Foriginal_n8qywa.jpg")

e4 = Event.create(title: "Vip tickets to Elvis Live!", description: "Wait what? Elvis? There is no way he is going to be on stage.... So then who's playing? Well, one way to find out! Join us Friday! We will be dancing and singing to Jailhouse Rock at 10pm sharp!! ", user_id: jenny.id, price: "$20", date: Date.new(2017, 11, 17), location: "Los Angeles", lat: 34.050879, lng: -118.216921, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490028961/elvis_pth2dy.jpg")
...
More on Le Youth
90s sounds refracted through a thoroughly modern aesthetic. Tracks that are serious about moving a dance floor full of people without coming on too strong. Breezy California vibes touched by a twist of European flair. Wes James is the artist behind Le Youth.", user_id: john.id, price: "$20", date: Date.new(2018, 2, 2), location: "Los Angeles", lat: 34.043625, lng: -118.256403, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490331475/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29106385_2F149753314296_2F1_2Foriginal_nzuijn.jpg")
...
At Turn - Boxed Lunch
2:30 PM - Distribution of Prizes", user_id: scott.id , price: "$150", date: Date.new(2018, 2, 27), location: "San Diego", lat: 32.723783, lng: -117.130918, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490332533/https-_2F_2Fcdn.evbuc.com_2Fimages_2F27288966_2F53052433536_2F1_2Foriginal_goyava.jpg")
#
...
January 26-April 20, 2017
15 slots with other studio clients in the mix
Price: $125 for 13-week class", user_id: nancy.id , price: "$70", date: Date.new(2018, 2, 27), location: "San Diego", lat: 32.697207, lng: -117.110319, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490332665/https-_2F_2Fcdn.evbuc.com_2Fimages_2F27102632_2F132905252681_2F1_2Foriginal_hiltpf.jpg")
#
...
KNW is a huge supporter of women in tech. We're proud to say that all of our events have featured outstanding women in the Silicon Beach community. If you're interested in helping us empower more women entrepreneurs and women in business please stop by our event and let us know how you want to get involved.", user_id: brandon.id, price: "$20", date: Date.new(2018, 2, 27), location: "Los Angeles", lat: 34.064390, lng: -118.237692, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490332987/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29529367_2F143123235359_2F1_2Foriginal_ncthf3.jpg")

e30 = Event.create(title: "Hip Hop Massive Party", description: "21+ event.
We are taking over Fridays in San Francisco. Will be the largest Friday hip hop party EVERY month. 15 tables, best looking venue in San Francisco, the Bay's best DJs playing the best music, best looking crowd around. We bring together some of the biggest promoters and hosts in the Bay Area to combine to make one huge massive party every 1st Friday of the month. Can check out previous Take Over Fridays pictures to verify how great the party is at www.facebook.com/ShapEvents", user_id: scott.id , price: "$40", date: Date.new(2018, 3, 27), location: "San Francisco", lat: 37.768237, lng: -122.448724, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490333226/https-_2F_2Fcdn.evbuc.com_2Fimages_2F29489732_2F133347295471_2F1_2Foriginal_o6rf96.jpg")
...
$10 Presale Passes are now available!", user_id: john.id , price: "$10", date: Date.new(2018, 4, 27), location: "San Francisco", lat: 37.788182, lng: -122.394479, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490333609/https-_2F_2Fcdn.evbuc.com_2Fimages_2F24276425_2F157247754704_2F1_2Foriginal_luvep5.jpg")
...
Didn't attend an HBCU? Not about that Greek life? No Problem! This event is for ALL PARTY GOERS, Millennials, and Tastemakers!", user_id: jenny.id, price: "$10", date: Date.new(2018, 2, 27), location: "Los Angeles", lat: 34.039500, lng: -118.261038, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490333718/https-_2F_2Fcdn.evbuc.com_2Fimages_2F28872430_2F92870650525_2F1_2Foriginal_quuejk.jpg")
...
Hope to see you there!", user_id: john.id, price: "$100", date: Date.new(2018, 2, 27), location: "San Francisco", lat: 37.764166, lng: -122.467263, image_url: "https://res.cloudinary.com/deh9l9lyq/image/upload/q_auto/v1490333839/https-_2F_2Fcdn.evbuc.com_2Fimages_2F28700932_2F157247754704_2F1_2Foriginal_qsdiys.jpg")
